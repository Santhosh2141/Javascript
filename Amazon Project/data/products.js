...
export function loadProducts(fun) {
  ...
  xhr.addEventListener('load',() => {
    ...
    // as we get a JSON response we need to convert it to a string;
    console.log('load products');
    //as send takes time. by the time the products list is recieved it runs the amazon.js file. here productsHtml is null.
